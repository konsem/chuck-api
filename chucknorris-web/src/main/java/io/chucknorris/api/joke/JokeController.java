...
public class JokeController {
    ...
    @RequestMapping(value = "/categories", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "=" + MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public @ResponseBody @RequestMapping(value = "/categories", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "="
            + MediaType.TEXT_PLAIN_VALUE, produces = MediaType.TEXT_PLAIN_VALUE) String getCategoryValues() {
     ...
     * @return joke
     */
    public @ResponseBody @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "="
            + MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE) Joke getJoke(@PathVariable String id) {
        return jokeRepository
                .findById(id)
                .orElseThrow(() -> new EntityNotFoundException("Joke with id \"" + id + "\" not found."));
    }
     ...
     */
    public @ResponseBody @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "="
            + MediaType.TEXT_PLAIN_VALUE, produces = MediaType.TEXT_PLAIN_VALUE) String getJokeValue(
    ...
    public @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "=" + MediaType.TEXT_HTML_VALUE, produces = MediaType.TEXT_HTML_VALUE) ModelAndView getJokeView(
     ...
     * @return joke
     */
    public @ResponseBody @RequestMapping(value = "/random", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "="
            + MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE) Joke getRandomJoke(
        ...
        if (name != null) {
            ...
            if (!(joke instanceof Joke)) {
                throw new EntityNotFoundException(
                        "No personalized jokes for name \""
                                + name
                                + "\" and category \""
                                + categoryString
                                + "\" found.");
     ...
     */
    public @ResponseBody @RequestMapping(value = "/random", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "="
            + MediaType.TEXT_PLAIN_VALUE, produces = MediaType.TEXT_PLAIN_VALUE) String getRandomJokeValue(
     ...
     */
    public @ResponseBody @RequestMapping(value = "/search", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "="
            + MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE) JokeSearchResult search(
                    @RequestParam(value = "query") @Size(min = 3, max = 120) final String query) {
    ...
    public @ResponseBody @RequestMapping(value = "/search", method = RequestMethod.GET, headers = HttpHeaders.ACCEPT + "="
            + MediaType.TEXT_PLAIN_VALUE, produces = MediaType.TEXT_PLAIN_VALUE) String searchValues(
                    @RequestParam(value = "query") @Size(min = 3, max = 120) final String query) {
        Joke[] jokes = jokeRepository.searchByQuery(query);
        StringBuilder stringBuilder = new StringBuilder();
